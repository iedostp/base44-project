    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-4 md:p-8 pb-24 md:pb-8" dir="rtl">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-slate-700">
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-700 dark:to-slate-600 rounded-xl p-4 border border-blue-200 dark:border-slate-600 text-right">
         ...
         <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 border-2 border-red-200 dark:border-red-900">
          ...
          <div className="bg-red-50 dark:bg-red-950 rounded-xl p-4 mb-4 border border-red-200 dark:border-red-900 text-right">
            <p className="text-sm text-red-800 dark:text-red-300 leading-relaxed">{t('deleteAccountWarning')}</p>
            <ul className="mt-3 space-y-1 text-sm text-red-700 dark:text-red-400 ml-5 list-disc text-right">
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
       <DialogContent className="dark:bg-slate-800 dark:border-slate-700" dir="rtl">
         ...
         <div className="bg-red-50 dark:bg-red-950 rounded-lg p-4 my-4 text-right">
